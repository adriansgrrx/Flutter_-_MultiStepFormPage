...
class DefaultSettingsBackup extends StatefulWidget {
  const DefaultSettingsBackup({super.key});

  @override
  State<DefaultSettingsBackup> createState() => _DefaultSettingsBackupState();
}

class _DefaultSettingsBackupState extends State<DefaultSettingsBackup> {
  @override
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(
                        top: 40.0, left: 253.0, bottom: 40.0),
                    child: MaterialButton(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(
                              0xFF2C3A76), // Red color for the button
